...
# 
# for (i in 1:10) {
#   x <- summary(survfit(Surv(mace_broad_censtime_yrs, mace_broad_censvar) ~ studydrug, data=noncal_cohort, subset=sglt2_benefit_decile==i),times=5)
# 
...
model <- cph(Surv(mace_broad_censtime_yrs, mace_broad_censvar) ~ studydrug*sglt2_benefit_decile, data=noncal_cohort, x=TRUE, y=TRUE, surv=TRUE)
...
model <- cph(Surv(mace_broad_censtime_yrs, mace_broad_censvar) ~ studydrug*sglt2_benefit_decile + dstartdate_age, data=noncal_cohort, x=TRUE, y=TRUE, surv=TRUE)
